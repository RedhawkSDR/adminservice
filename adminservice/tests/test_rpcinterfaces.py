...
from adminservice.tests.base import _NOW
from adminservice.tests.base import _TIMEFORMAT
...
class MainXMLRPCInterfaceTests(TestBase):
    ...
    def test_ctor(self):
        interface = self._makeOne([('adminservice', None)])
...
class SupervisorNamespaceXMLRPCInterfaceTests(TestBase):
    ...
    def test_update(self):
        from adminservice import xmlrpc
        from adminservice.adminserviced import SupervisorStates
    ...
    def test_getSupervisorVersion(self):
        ...
        from adminservice import options
    ...
    def test_getState(self):
        ...
        statename = getAdminServiceStateDescription(statecode)
...
class SystemNamespaceXMLRPCInterfaceTests(TestBase):
    ...
    def _makeOne(self):
        ...
        return self._getTargetClass()(
            [('adminservice', supervisor),
             ]
            )

    def test_ctor(self):
        interface = self._makeOne()
        self.assertTrue(interface.namespaces['adminservice'])
...
class Test_make_main_rpcinterface(unittest.TestCase):
    def _callFUT(self, supervisord):
        from adminservice.rpcinterface import make_main_rpcinterface
