"""Test suite for adminservice.datatypes"""
...
class InetStreamSocketConfigTests(unittest.TestCase):
    ...
    def test_repr(self):
        ...
        self.assertTrue(s.startswith(
            '<adminservice.datatypes.InetStreamSocketConfig at'), s)
...
class UnixStreamSocketConfigTests(unittest.TestCase):
    ...
    def test_repr(self):
        ...
        s = repr(conf)
        self.assertTrue(s.startswith(
            '<adminservice.datatypes.UnixStreamSocketConfig at'), s)
...
class ColonSeparatedUserGroupTests(unittest.TestCase):
    ...
    def test_separated_user_group_returns_both(self):
        ...
        @patch("adminservice.datatypes.name_to_uid", name_to_uid)
        @patch("adminservice.datatypes.name_to_gid", name_to_gid)
