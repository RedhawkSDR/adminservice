...
from adminservice.poller import SelectPoller, PollPoller, KQueuePoller
from adminservice.poller import implements_poll, implements_kqueue
...
class BasePollerTests(unittest.TestCase):
    def _makeOne(self, options):
        from adminservice.poller import BasePoller
