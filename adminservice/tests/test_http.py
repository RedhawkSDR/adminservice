...
from adminservice.tests.base import PopulatedDummySupervisor
from adminservice.tests.base import DummyRPCInterfaceFactory
...
class LogtailHandlerTests(HandlerTests, unittest.TestCase):
    def _getTargetClass(self):
        from adminservice.http import logtail_handler
...
class MainLogTailHandlerTests(HandlerTests, unittest.TestCase):
    def _getTargetClass(self):
        from adminservice.http import mainlogtail_handler
...
class TailFProducerTests(unittest.TestCase):
    def _getTargetClass(self):
        from adminservice.http import tail_f_producer
...
class DeferringChunkedProducerTests(unittest.TestCase):
    def _getTargetClass(self):
        from adminservice.http import deferring_chunked_producer
...
class DeferringCompositeProducerTests(unittest.TestCase):
    def _getTargetClass(self):
        from adminservice.http import deferring_composite_producer
...
class DeferringGlobbingProducerTests(unittest.TestCase):
    def _getTargetClass(self):
        from adminservice.http import deferring_globbing_producer
...
class DeferringHookedProducerTests(unittest.TestCase):
    def _getTargetClass(self):
        from adminservice.http import deferring_hooked_producer
...
class DeferringHttpRequestTests(unittest.TestCase):
    def _getTargetClass(self):
        from adminservice.http import deferring_http_request
...
class DeferringHttpChannelTests(unittest.TestCase):
    def _getTargetClass(self):
        from adminservice.http import deferring_http_channel
...
class EncryptedDictionaryAuthorizedTests(unittest.TestCase):
    def _getTargetClass(self):
        from adminservice.http import encrypted_dictionary_authorizer
...
class SupervisorAuthHandlerTests(unittest.TestCase):
    def _getTargetClass(self):
        from adminservice.http import supervisor_auth_handler
...
class LogWrapperTests(unittest.TestCase):
    def _getTargetClass(self):
        from adminservice.http import LogWrapper
        return LogWrapper
