...
from adminservice.tests.base import DummyStream
...
class FileHandlerTests(HandlerTests, unittest.TestCase):
    def _getTargetClass(self):
        from adminservice.loggers import FileHandler
        return FileHandler
...
class RotatingFileHandlerTests(FileHandlerTests):
    ...
    def _getTargetClass(self):
        from adminservice.loggers import RotatingFileHandler
...
class BoundIOTests(unittest.TestCase):
    def _getTargetClass(self):
        from adminservice.loggers import BoundIO
        return BoundIO
...
class LoggerTests(unittest.TestCase):
    def _getTargetClass(self):
        from adminservice.loggers import Logger
        return Logger
...
class SyslogHandlerTests(HandlerTests, unittest.TestCase):
    ...
    def _getTargetClass(self):
        return __import__('adminservice.loggers').loggers.SyslogHandler
