...
class EntryPointTests(unittest.TestCase):
    def test_main_noprofile(self):
        from adminservice.adminserviced import main
        conf = os.path.join(
...
class SupervisordTests(unittest.TestCase):
    ...
    def _getTargetClass(self):
        from adminservice.adminserviced import Supervisor
        return Supervisor
    ...
    def test_handle_sigchld(self):
        ...
        supervisord.handle_signal()
        self.assertEqual(supervisord.options.mood, 1)
        # adminservice.options.signame(signal.SIGCHLD) may return "SIGCLD"
    ...
    def test_diff_changed(self):
        from adminservice.options import ProcessConfig, ProcessGroupConfig
    ...
    def test_diff_changed_eventlistener(self):
        ...
        from adminservice.options import EventListenerConfig, EventListenerPoolConfig
        ...
        def make_gconfig(name, pconfigs, pool_events, result_handler='adminservice.dispatchers:default_handler'):
    ...
    def test_getSupervisorStateDescription(self):
        ...
        from adminservice.states import SupervisorStates
        result = getAdminServiceStateDescription(SupervisorStates.RUNNING)
