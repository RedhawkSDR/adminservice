...
class TestEventTypes(unittest.TestCase):
    def test_ProcessLogEvent_attributes(self):
        from adminservice.events import ProcessLogEvent
    ...
    def test_ProcessLogEvent_inheritence(self):
        from adminservice.events import ProcessLogEvent
        from adminservice.events import Event
        self.assertTrue(
            issubclass(ProcessLogEvent, Event)
        )

    def test_ProcessLogStdoutEvent_attributes(self):
        from adminservice.events import ProcessLogStdoutEvent
    ...
    def test_ProcessLogStderrEvent_attributes(self):
        from adminservice.events import ProcessLogStderrEvent
    ...
    def _test_one_SupervisorStateChangeEvent(self, klass):
        from adminservice.events import SupervisorStateChangeEvent
    ...
    def _test_one_ProcessStateEvent(self, klass):
        ...
        from adminservice.events import ProcessStateEvent
    ...
    def _test_one_TickEvent(self, klass):
        from adminservice.events import TickEvent
    ...
    def test_ProcessGroupAddedEvent_attributes(self):
        from adminservice.events import ProcessGroupAddedEvent
    ...
    def test_ProcessGroupRemovedEvent_attributes(self):
        from adminservice.events import ProcessGroupRemovedEvent
