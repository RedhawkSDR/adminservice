...
from adminservice.tests.base import DummyRPCServer

class ControllerTests(unittest.TestCase):
    def _getTargetClass(self):
        from adminservice.rhadmin import Controller
        return Controller
    ...
    def test__upcheck_unknown_method(self):
        ...
        self.assertEqual(controller.stdout.getvalue(),
                         ...
                         ' the adminservice namespace commands that'
                         ' supervisorctl uses to control it.  Please check'
                         ' that the [rpcinterface:adminservice] section is'
...
class TestControllerPluginBase(unittest.TestCase):
    def _getTargetClass(self):
        from adminservice.rhadmin import ControllerPluginBase
...
class TestDefaultControllerPlugin(unittest.TestCase):
    ...
    def test_reread_shutdown_state(self):
        ...
        plugin.do_reread(None)
        self.assertEqual(plugin.ctl.stdout.getvalue(),
                         'ERROR: adminservice shutting down\n')
    ...
    def test_maintail_help(self):
        ...
        out = plugin.ctl.stdout.getvalue()
        self.assertTrue("tail of adminservice main log file" in out)
    ...
    def _dont_test_maintail_dashf(self):
        # https://github.com/Supervisor/adminservice/issues/285
    ...
    def test_exit_help(self):
        ...
        plugin.help_exit()
        out = plugin.ctl.stdout.getvalue()
        self.assertTrue("Exit the adminservice shell" in out)
