...
import time
import xmlrpclib
from adminservice.xmlrpc import AdminServiceTransport
...
def getRPCTransport(env):
    u = env.get('ADMINSERVICE_USERNAME', '')
    p = env.get('ADMINSERVICE_PASSWORD', '')
    return AdminServiceTransport(u, p, env['ADMINSERVICE_SERVER_URL'])
